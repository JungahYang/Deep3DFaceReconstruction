...
def main(args):
    ...
    if args.opt == 'obj':
        ...
        print("추론 끝 \n 3D Image 추론 시간 : ", time.time()-start)
    else:
        param_lst, roi_box_lst  = tddfa(img, boxes)
    ...
    wfp = f'/mnt/DATA/yg/uniinfo/3DDFA_V2/examples/results/{args.img_fp.split("/")[-1].replace(old_suffix, "")}_{args.opt}' + new_suffix
    ...
    if args.opt == '2d_sparse':
        ...
        uv_tex(img, ver_lst, tddfa.tri, uv_h=1024, uv_w=1024, show_flag=args.show_flag, wfp=wfp)
    elif args.opt == 'pose':
...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--config', type=str, default='/mnt/DATA/yg/uniinfo/3DDFA_V2/configs/mb1_120x120.yml')
